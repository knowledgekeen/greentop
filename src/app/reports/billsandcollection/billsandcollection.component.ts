  ...
  filterBCdata() {
    ...
    for (let j in this.allpayments) {
      this.allbillsncollection.push({
        ...
        billno: "-",
        particulars:
          this.allpayments[j].paymode != this.allpayments[j].particulars
            ? `${this.allpayments[j].paymode} - ${this.allpayments[j].name}, ${this.allpayments[j].particulars}`
            : `${this.allpayments[j].paymode} - ${this.allpayments[j].name}`,
        billamt: 0,
